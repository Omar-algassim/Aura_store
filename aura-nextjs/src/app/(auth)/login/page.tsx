  ...
  return (
    <div className='w-full max-w-screen-tablet mx-9 py-10 border-none rounded-3xl bg-white flex flex-col items-center gap-8'>
      ...
      {/* show more options [email/password form] */}
        <div dir='rtl' className='overflow-hidden w-full px-4 pb-4 flex flex-col items-center justify-center'>
          <LoginForm />
        </div>
        {/* forget password */}
        <div className=''>
          <Link href={'/forget-password'}
          className='text-foreground text-[14px] font-[400] hover:opacity-75 focus:outline-none transition-colors duration-500'>نسيت كلمة المرور</Link>
        </div>
        {/* doesn't have account */}
        <div className='w-full flex  justify-center gap-2'>
          <div className='flex items-center justify-center pt-[1.2px] m-0 h-[24px]'>
            <p className='text-[12px] text-secondary align-center'> ليس لديكي حساب ؟</p>
          </div>
          <div className='flex items-center justify-center p-0  m-0 h-[24px]'>
            <Link href={'/register'}
            className='text-primary-dark text-[14px] font-[400] hover:text-primary transition-colors duration-500'> انشاء حساب</Link>
          </div>
        </div>
      </div>
