...
function ConfirmPhonePage() {
  ...
  const handleSubmit = () => {
    console.log(`submitting code ${code}for user ${user.username} with ${user.documentId}`);
    setCode('');
  }
  ...
  return (
    <div className='flex flex-col w-[364px] tablet:w-full tablet:max-w-[880px] border-none rounded-3xl pt-10 pb-6 px-6 gap-8 tablet:mt-20 bg-white justify-center items-center'>
      ...
      <div className='w-full flex flex-col items-center justify-center space-y-2'>
        <ButtonSecondary disabled={!canResend} className='bg-white border-none hover:bg-white hover:text-primary-dark active:bg-white active:text-primary-dark focus:outline-none focus:bg-white focus:text-primary-dark flex flex-col gap-1'>
          إعادة إرسال الرمز
