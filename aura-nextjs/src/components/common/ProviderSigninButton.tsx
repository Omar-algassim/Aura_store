...
function ProviderSigninButton(
  ...
  return (
    <Link href={`${BaseUrl}/connect/${provider}`} className='w-[320px] h-[56px] py-3 px-6 rounded-[12px] flex items-center gap-[10px] bg-surface text-foreground hover:ring-[0.5px] hover:-ring-offset-1 hover:ring-opacity-5 hover:ring-primary transition-all
    ' onClick={handleClick}>
