...
export const newProductSchema = z.object({
  ...
  description: z
    .string()
    .min(10, 'please enter a description or the description is too short'),
  ...
  weight: z
    ...
    .refine((value) => {
      ...
      return (
        parsedWeight &&
        typeof parsedWeight.value === 'number' &&
        parsedWeight.value > 0 &&
        typeof parsedWeight.unit === 'string' &&
        parsedWeight.unit.length > 0
      );
    }, 'Please enter a valid weight value and unit.'),
});
