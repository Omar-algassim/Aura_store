...
export interface ApiAvailableCitieAvailableCitie
  ...
  info: {
    ...
    pluralName: 'available-cities';
    singularName: 'available-citie';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAvailableCountryAvailableCountry
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    available_cities: Schema.Attribute.Relation<
      'oneToMany',
      'api::available-citie.available-citie'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiBestSellingBestSelling extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    peroid_end: Schema.Attribute.Date & Schema.Attribute.Required;
    product_id: Schema.Attribute.Relation<'oneToOne', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    sold: Schema.Attribute.BigInteger & Schema.Attribute.Required;
...
export interface ApiHotRegionHotRegion extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'hot_region';
    pluralName: 'hot-regions';
    singularName: 'hot-region';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSteadySellingSteadySelling
  ...
  info: {
    description: '';
    displayName: 'steady_selling';
    pluralName: 'steady-sellings';
    singularName: 'steady-selling';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::steady-selling.steady-selling'
    > &
      Schema.Attribute.Private;
    period_start: Schema.Attribute.Date & Schema.Attribute.Required;
    peroid_end: Schema.Attribute.Date & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::available-country.available-country': ApiAvailableCountryAvailableCountry;
